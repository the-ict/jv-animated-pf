...
const mockProjectData = [
    {
        ...
        projectLeftTexts: {
            ...
            subtitle: "With simplicity, flexibility, and maintainability in mind we built a website uniquely mega."
        },
        projectRightTexts: {
            title: "Powered by a Craft CMS back-end the website is easy to manage and update. There are several customizable content blocks that can be added and rearranged to make case studies be presented in a meaningful way."
        },
